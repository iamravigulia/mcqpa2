<div>
    ...
    <form action="{{route('fmt.mcqpa2.store')}}" method="post" class="fmt_box" enctype="multipart/form-data">
        ...
        <div class="fmt_headline">Add a MCQpa2</div>
        ...
        <div style="margin:10px 10px;">
            ...
            <input style="width:100%" class="fmt_input" type="text" name="question" placeholder="Question" style="width: 100%;" required>
        </div>
        <div class="fmt_flex">
            <div style="margin:10px 10px;">
        ...
        <div class="fmt_flex">
            ...
            <div style="margin:2px 20px;">
                <label class="fmt_label" for="">Image</label>
                <input style="display:block;" type="file" accept="image/*" name="answer_1_image" id="">
            </div>
            <div>
        ...
        <div class="fmt_flex">
            ...
            <div style="margin:2px 20px;">
                <label class="fmt_label" for="">Image</label>
                <input style="display:block;" type="file" accept="image/*" name="answer_2_image" id="">
            </div>
            <div>
                <label class="fmt_label" for="">Correct</label>
        ...
        <div class="fmt_flex">
            ...
            <div style="margin:2px 20px;">
                <label class="fmt_label" for="">Image</label>
                <input style="display:block;" type="file" accept="image/*" name="answer_3_image" id="">
            </div>
            <div>
                <label class="fmt_label" for="">Correct</label>
        ...
        <div class="fmt_flex">
            ...
            <div style="margin:2px 20px;">
                <label class="fmt_label" for="">Image</label>
                <input style="display:block;" type="file" accept="image/*" name="answer_4_image" id="">
            </div>
            <div>
                <label class="fmt_label" for="">Correct</label>
        ...
        <div class="fmt_flex">
            ...
            <div style="margin:2px 20px;">
                <label class="fmt_label" for="">Image</label>
                <input style="display:block;" type="file" accept="image/*" name="answer_5_image" id="">
            </div>
            <div>
                <label class="fmt_label" for="">Correct</label>
        ...
        <div class="fmt_flex">
            ...
            <div style="margin:2px 20px;">
                <label class="fmt_label" for="">Image</label>
                <input style="display:block;" type="file" accept="image/*" name="answer_6_image" id="">
            </div>
            <div>
                <label class="fmt_label" for="">Correct</label>
    ...
    {{--  --}}
    <form action="{{route('fmt.mcqpa2.csv')}}" method="POST" enctype='multipart/form-data' style="margin:20px 40px;">
        @csrf
        <input type="integer" name="problem_set_id" value="{{$pbs72 ?? ''}}" hidden style="border:1px solid #000000;">
        <input type="integer" name="format_type_id" value="{{$fmt72 ?? ''}}" hidden style="border:1px solid #000000;">
